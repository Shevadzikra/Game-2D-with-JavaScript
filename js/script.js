window.addEventListener('load', function() {
    ...
    class Enemy { // parent class for enemies
        constructor(game) {
            this.game = game;
    ...
    class Angler1 extends Enemy { // child class of class Enemy
        constructor(game) {
            super(game);
            this.width = 228 * 0.2;
            this.height = 169 * 0.2;
    ...
    class Game {
        constructor(height, width) {
            ...
            this.ammo = 20; // jumlah peluru saat ditembak
            this.maxAmmo = 50;
            this.ammoTimer = 0;
    ...
    function animate(timeStamp) {
        ...
        // console.log(deltaTime); // 1000ms (1 second) / 16.6 = 60fps
        lastTime = timeStamp;
